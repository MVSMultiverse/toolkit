...
const langs: Language[] = [{ locale: 'ar-SA', language: 'العربية', code: 'ar' }, // العربية   AR
{ locale: 'en-US', language: 'English', code: 'en' }, // English   EN
{ locale: 'es-ES', language: 'Español', code: 'es-ES' }, // Español   ESES
{ locale: 'fr-FR', language: 'Français', code: 'fr' }, // Français FR
{ locale: 'ja-JP', language: '日本語', code: 'ja' },  // 日本語  JA
{ locale: 'ko-KR', language: '한국어', code: 'ko' },   // 한국어  KO
{ locale: 'pt-PT', language: 'Português', code: 'pt-pt' },  // Português  PTPT
{ locale: 'ru-RU', language: 'Русский', code: 'ru' },  // Русский  RU
{ locale: 'tr-TR', language: 'Türkçe', code: 'tr' }, // Türkçe TR
{ locale: 'vi-VN', language: 'Tiếng Việt', code: 'vi' }, // Tiếng Việt  VI
...
const UserMenuComponent: React.FC<{ variant?: Variant; text?: string; account?: string }> = ({
  ...
  return (
    <DropdownMenu items={userMenulinks} py="12px" direction="top">
      <StyledUserMenu>
  ...
  return (
    <MemoryRouter initialEntries={["/teams"]}>
      <Menu
        ...
        setLang={noop}
        currentLang="EN"
        mvsPriceUsd={0.23158668932877668}
        links={links}
        subLinks={subLinks}
        footerLinks={footerLinks}
      >
